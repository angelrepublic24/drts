...
export const Products = () => {
    ...
    const products = [    
        ...
        { id: 3, name: "REDIES", description: "Inventory Manager", img: "/products/redies.png", bg: 'bg-teal-100', textbg: 'bg-teal-50'},
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 max-w-full px-6">
          {products.map((product, index) => (
            <div key={index} className={`rounded-lg w-full  shadow-md text-center ${product.bg} overflow-hidden `}>
              ...
              <div className={`w-full ${product.textbg} p-6 md:h-full grid grid-cols-2 gap-2`}>
                ...
                <div className="flex justify-end items-start  md:mr-2">
                  <div className="bg-emerald-400 w-12 h-12 rounded-lg flex items-center justify-center">
